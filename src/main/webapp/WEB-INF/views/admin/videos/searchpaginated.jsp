						...
						<nav aria-label="Page navigation">
							<ul class="pagination justify-content-center">
								<li
									...
									<a class="page-link"
									href="<c:url value='/admin/categories/searchpaginated?name=${categoryname}&size=${categoryPage.size}&page=${1}'/>"
								...
								<c:forEach items="${pageNumbers}" var="pageNumber">
									<c:if test="${categoryPage.totalPages >1}">
										<li class="${pageNumber == categoryPage.number +1 ? 'page-item active' : 'page-item'}">
											<a class="page-link" href="<c:url value='/admin/categories/searchpaginated?name=${categoryname}&size=${categoryPage.size}&page=${pageNumber}'/>">${pageNumber}</a>
										</li>
									</c:if>
								</c:forEach>
								...
								<li
									...
									<a class="page-link"
									href="<c:url value='/admin/categories/searchpaginated?name=${categoryname}&size=${categoryPage.size}&page=${categoryPage.totalPages}'/>">Last</a>
								</li>
